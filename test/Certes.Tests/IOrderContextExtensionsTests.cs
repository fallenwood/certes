...
public class IOrderContextExtensionsTests
{
    ...
    public async Task CanGenerateWithAlternateLink()
    {
        ...
        httpClientMock.Setup(m => m.Post<string>(certDefaultLoc, It.IsAny<object>(), It.IsAny<JsonTypeInfo>(), It.IsAny<JsonTypeInfo<string>>()))
        ...
        httpClientMock.Setup(m => m.Post<string>(certAlternateLoc, It.IsAny<object>(), It.IsAny<JsonTypeInfo>(), It.IsAny<JsonTypeInfo<string>>()))
            .ReturnsAsync(new AcmeHttpResponse<string>(
                accountLoc, 
                alternatepem,
                alternates, 
        ...
        httpClientMock.Setup(m => m.Post<Order>(finalizeLoc, It.IsAny<object>(), It.IsAny<JsonTypeInfo>(), It.IsAny<JsonTypeInfo<Order>>()))
        ...
        // acmeContextMock.Object, orderLoc
        var orderCtxMock = new MockOrderContext(acmeContextMock.Object, orderLoc, new Order
        {
            Identifiers = new[] {
                new Identifier { Value = "www.certes.com", Type = IdentifierType.Dns },
            },
...
internal class MockOrderContext(IAcmeContext context, Uri location, Order resource) : OrderContext(context, location)
{
    public override Task<Order> Resource()
    {
