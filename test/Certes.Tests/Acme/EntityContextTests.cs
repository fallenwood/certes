...
public class EntityContextTests
{
    ...
    public async Task CanLoadResource()
    {
        ...
        ctxMock
            ...
            .Returns(1);
        ctxMock
            .Setup(c => c.Sign(It.IsAny<object>(),  It.IsAny<Uri>(), It.IsAny<JsonTypeInfo>()))
        ...
        httpMock
            .Setup(m => m.Post<Account>(location, It.IsAny<JwsPayload>(), It.IsAny<JsonTypeInfo>(), It.IsAny<JsonTypeInfo<Account>>()))
        ...
        var ctx = new EntityContext<Account>(ctxMock.Object, location, AcmeJsonSerializerContext.Unindented.Account);
        ...
        ctx = new EntityContext<Account>(ctxMock.Object, location, AcmeJsonSerializerContext.Unindented.Account);
