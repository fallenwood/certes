...
internal class OrderContext : EntityContext<Order>, IOrderContext
{
    public OrderContext(
        ...
        Uri location)
        : base(context, location, AcmeJsonSerializerContext.Unindented.Order)
    {
    }
    ...
    public async Task<Order> Finalize(byte[] csr)
    {
        ...
        var resp = await Context.HttpClient.Post<Order>(Context, order.Finalize, payload, true, AcmeJsonSerializerContext.Unindented.Uri, AcmeJsonSerializerContext.Unindented.Order);
    ...
    {
        var order = await Resource();
        var resp = await Context.HttpClient.Post<string>(Context, order.Certificate, null, false, AcmeJsonSerializerContext.Unindented.Uri, AcmeJsonSerializerContext.Unindented.String);
        ...
        {
            resp = await Context.HttpClient.Post<string>(Context, alternate, null, false, AcmeJsonSerializerContext.Unindented.Uri, AcmeJsonSerializerContext.Unindented.String);
