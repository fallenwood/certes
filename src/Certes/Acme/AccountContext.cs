...
/// 
/// </summary>
public record NewAccountHeader
{
    /// <summary>
    /// 
    /// </summary>
...
internal class AccountContext : EntityContext<Account>, IAccountContext
{
    ...
    public AccountContext(IAcmeContext context, Uri location)
        : base(context, location, AcmeJsonSerializerContext.Unindented.Account)
    {
    }
    ...
    public async Task<Account> Deactivate()
    {
        ...
        var resp = await Context.HttpClient.Post<Account>(Context, Location, payload, true, AcmeJsonSerializerContext.Unindented.Account, AcmeJsonSerializerContext.Unindented.Account);
    ...
    public async Task<Account> Update(IList<string> contact = null, bool agreeTermsOfService = false)
    {
        ...
        var response = await Context.HttpClient.Post<Account>(Context, location, account, true, AcmeJsonSerializerContext.Unindented.Uri, AcmeJsonSerializerContext.Unindented.Account);
        ...
        string eabKeyId = null, string eabKey = null, string eabKeyAlg = null)
    {
        ...
        {
            var header = new NewAccountHeader
            {
            ...
            var headerJson = JsonSerializer.Serialize(header, AcmeJsonSerializerContext.Unindented.NewAccountHeader);
            ...
            var accountKeyBase64 = JwsConvert.ToBase64String(
                System.Text.Encoding.UTF8.GetBytes(
                    JsonSerializer.Serialize(context.AccountKey.JsonWebKey, AcmeJsonSerializerContext.Unindented.AsymmetricCipherKey)));
        ...
        return await context.HttpClient.Post<Account>(jws, endpoint, body, ensureSuccessStatusCode, AcmeJsonSerializerContext.Unindented.Account, AcmeJsonSerializerContext.Unindented.Account);
    }
}
