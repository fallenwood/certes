...
internal class ChallengeContext : EntityContext<Challenge>, IChallengeContext
{
    ...
    public ChallengeContext(
        ...
        string type,
        string token)
        : base(context, location, AcmeJsonSerializerContext.Unindented.Challenge)
    {
        Type = type;
        Token = token;
    }
    ...
    {
        var resp = await Context.HttpClient.Post<Challenge>(Context, Location, new {}, true, AcmeJsonSerializerContext.Unindented.Uri, AcmeJsonSerializerContext.Unindented.Challenge);
