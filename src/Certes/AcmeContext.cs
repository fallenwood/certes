...
public class AcmeContext : IAcmeContext
{
    ...
    public async Task<Account> ChangeKey(IKey key)
    {
        ...
        var body = jws.Sign(keyChange, url: endpoint, jsonTypeInfo: AcmeJsonSerializerContext.Unindented.KeyChange);

        var resp = await HttpClient.Post<Account>(this, endpoint, body, true, AcmeJsonSerializerContext.Unindented.JwsPayload, AcmeJsonSerializerContext.Unindented.Account);
    ...
    public async Task<Directory> GetDirectory()
    {
        if (directory == null)
        {
            var resp = await HttpClient.Get<Directory>(DirectoryUri, AcmeJsonSerializerContext.Unindented.Directory);
    ...
    public async Task RevokeCertificate(byte[] certificate, RevocationReason reason, IKey certificatePrivateKey)
    {
        ...
        if (certificatePrivateKey != null)
        {
            ...
            await HttpClient.Post<string>(jws, endpoint, body, true, AcmeJsonSerializerContext.Unindented.CertificateRevocation, AcmeJsonSerializerContext.Unindented.String);
        }
        else
        {
            await HttpClient.Post<string>(this, endpoint, body, true, AcmeJsonSerializerContext.Unindented.CertificateRevocation, AcmeJsonSerializerContext.Unindented.String);
    ...
    public async Task<IOrderContext> NewOrder(IList<string> identifiers, DateTimeOffset? notBefore = null, DateTimeOffset? notAfter = null)
    {
        ...
        var order = await HttpClient.Post<Order>(this, endpoint, body, true, AcmeJsonSerializerContext.Unindented.Order, AcmeJsonSerializerContext.Unindented.Order);
    ...
    public async Task<JwsPayload> Sign(object entity, Uri uri, JsonTypeInfo jsonTypeInfo)
    {
